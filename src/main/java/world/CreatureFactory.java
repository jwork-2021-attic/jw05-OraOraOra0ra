...
public class CreatureFactory {
    ...
    public Creature newHuluwa(int No, int messages, String no, String colorName, Color color, int v, int maxHP, int attack, int defense) {
        Creature huluwa = new Creature(No, this.world, new ImageView(no + ".jpg"), colorName, color, 100, maxHP, attack, defense);
    ...
    public Creature newHuluwa(int No, int x, int y, int messages, String no, String colorName, Color color, int v, int maxHP, int attack, int defense) {
        Creature huluwa = new Creature(No, this.world, new ImageView(no + ".jpg"), colorName, color, 100, maxHP, attack, defense);
        world.myLocation(huluwa,x,y);
        huluwa.setSize(messages);
        new MonsterAI(huluwa, messages, v);
        return huluwa;
    }
    ...
    public Creature newPlayer(int No, int x, int y, int messages, String no, String colorName, Color color, int maxHP, int attack, int defense) {
        Creature player = new Creature(No, this.world, new ImageView(no + ".jpg"), colorName, color, 100, maxHP, attack, defense);
        world.myLocation(player,x,y);
        player.setSize(messages);
