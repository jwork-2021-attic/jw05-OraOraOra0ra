...
public class Creature implements Serializable {
    ...
    public void moveBy(int mx, int my) {
        ...
        try {
            ...
            if (legal(mx,my) && other==null ){//&& (world.tile(x+mx,y+my)==Tile.FLOORS || world.tile(x+mx,y+my)==Tile.FLOORF || world.tile(x+mx,y+my)==Tile.FLOORW)) {
                ai.onEnter(x() + mx, y() + my, world.tile(x() + mx, y() + my));
                if (world.tile(x,y)==Tile.FLOORW) {
                    if (color == Color.GRAY) {
                        world.setTile(x, y, Tile.FLOORS);
                    } else if (color == Color.BLACK) {
                        world.setTile(x, y, Tile.FLOORF);
                    }
                    size++;
                }
            } else if (other!=null) {
    ...
    public Creature(int No, World world, String colorName, Color color, int visionRadius, int maxHP, int attack, int defense) {
        this.No = No;
        this.world = world;
